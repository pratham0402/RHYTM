...
public class online_SongInfo {

    String songCategory, songTitle, songArtist, songAlbumArt, songDur, songLink, mkey;

    public online_SongInfo(String songCategory, String songTitle, String songArtist, String songAlbumArt, String songDur, String songLink) {
